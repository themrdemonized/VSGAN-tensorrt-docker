...
for f in files:
    ...
    # hevc_nvenc
    # os.system(
    #     f"vspipe -c y4m inference_batch.py --arg source={f} - | ffmpeg -y -i {f} {common} -c:v hevc_nvenc -tag:v hvc1 -pix_fmt yuv420p -tier high -preset p7 -rc constqp -qp 35 -rc-lookahead 20 -b:v 0 {mux_path}"
    # )
